...
export default function SplitScreen() {
  ...
  const handleLogin = (e) => {
    ...
    if (token) {
      ...
      // Aqui você normalmente faria uma requisição para seu backend para validar o email e a senha
      localStorage.setItem('token', 'seuTokenDeAutenticacao'); // Substitua pelo token real recebido do backend
      navigate('/HomePageLogada');
    }
  };
