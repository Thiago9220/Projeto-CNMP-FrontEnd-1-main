      ...
      <Box maxW="md" mx="auto" mt={8} p={6} borderWidth={1} borderRadius="md" boxShadow="lg">
        ...
        <form>
          <VStack spacing={4}>
            ...
            <HStack spacing={4} width="100%">
              <FormControl id="superiorImediato">
            ...
            <HStack spacing={4} width="100%">
              <FormControl id="perfil">
                ...
                <Select placeholder="Selecione o perfil">
                  ...
                  <option value="perfilSeguranca">Perfil Segurança</option>
                  <option value="visualizadorPainelRelatorio">Visualizador de Painel/Relatório</option>
                </Select>
              </FormControl>
              <FormControl id="tipoAutenticacao" isRequired>
                <FormLabel>Tipo de Autenticação</FormLabel>
                <Select placeholder="Selecione o tipo de autenticação">
                  <option value="senha">Senha</option>
                  <option value="biometria">Token</option>
                </Select>
              </FormControl>
            </HStack>
            <HStack spacing={4} width="100%">
